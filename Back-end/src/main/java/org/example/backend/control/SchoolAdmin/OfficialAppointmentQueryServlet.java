...
@WebServlet("/official-appointments/query")
public class OfficialAppointmentQueryServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (jwtPayload == null || (int) jwtPayload.get("admin_role") != 1) {
            out.print("{\"code\": 403, \"msg\": \"Forbidden: Only school admins can view all official appointments\", \"data\": null}");
            return;
        }

        try {
            ArrayList<AppointmentBean> appointments = appointmentDao.getAllOfficialAppointments();
